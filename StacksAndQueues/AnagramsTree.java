...
public class AnagramsTree {
    ...
    static boolean check(Node root1, Node root2){
        ...
        q2.add(root2);
        while(true){
            // n1 number of nodes at current level root 1
            // n2 number of nodes at current level root 2
    ...
    public static void main(String[] args) {
        ...
        System.out.println(check(root1, root2)?"Yes" : "No");
    }
}
